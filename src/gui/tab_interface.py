...
class TabInterface:
    ...
    def __init__(self) -> None:
        ...
        self.interface_package_frame = ttk.Frame(self.paned_window, style="My.TFrame")
        ...
        interface_package_label = ttk.Label(
            self.interface_package_frame, text="Packages:", padding=5, style="My.TLabel"
        )
        interface_package_info = ttk.Label(
            self.interface_package_frame, text="Undo/Redo: Ctrl-z/Ctrl-Z,Ctrl-y", padding=5, style="My.TLabel"
        )
        ...
        interface_package_scroll = ttk.Scrollbar(
            ...
            orient=tk.VERTICAL,
            cursor="arrow",
            command=self.interface_packages_text.yview,
        ...
        interface_generics_frame = ttk.Frame(self.paned_window, style="My.TFrame")
        ...
        self.interface_generics_label = ttk.Label(
            interface_generics_frame, text="Generics:", padding=5, style="My.TLabel"
        )
        interface_generics_info = ttk.Label(
            interface_generics_frame, text="Undo/Redo: Ctrl-z/Ctrl-Z,Ctrl-y", padding=5, style="My.TLabel"
        )
        ...
        interface_ports_frame = ttk.Frame(self.paned_window, style="My.TFrame")
        ...
        interface_ports_label = ttk.Label(interface_ports_frame, text="Ports:", padding=5, style="My.TLabel")
        interface_ports_linfo = ttk.Label(
            interface_ports_frame, text="Undo/Redo: Ctrl-z/Ctrl-Z,Ctrl-y", padding=5, style="My.TLabel"
        )
        ...
        interface_ports_scroll = ttk.Scrollbar(
            ...
            orient=tk.VERTICAL,
            cursor="arrow",
            command=self.interface_ports_text.yview,
            style="My.Vertical.TScrollbar",
        )
